...
from Func_Extract_Data import Extract_by_name,Extract_Track_Data
...
HNS = ['Dorian'] #['Teddy','Maria','Lorenzo','Iota','Igor','Dorian']
    ...
    for GS in GSS:
        ...
        for HN in HNS:
            ...
            for csv_file in csv_files:
                ...
                # if (HN =='Irma' and GS!='2km'):
                #     Eye_Lats=Eye_Lats[:-1]
                #     Eye_Longs=Eye_Longs[:-1]
                #     simulated_wind_intensities=simulated_wind_intensities[:-1]
                #     simulated_min_slp=simulated_min_slp[:-1]
