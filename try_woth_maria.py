...
#                             im_cbar = ax[hn_counter,i].contourf(to_np(lons), to_np(lats), to_np(wspd_500), 35,
#                                 transform=crs.PlateCarree(),vmin=5 ,vmax=62,
#                                 cmap= cmap)
#                         else:
#                             im = ax[hn_counter,i].contourf(to_np(lons), to_np(lats), to_np(wspd_500), 35,
#                                 transform=crs.PlateCarree(),vmin=5 ,vmax=62,
#                                 cmap= cmap)
...
#                         elif HN=='Dorian':
#                             ax[hn_counter,i].set_extent([-70.1,-71.4, 24.85 , 26.15])
...
for CL in CLS: 
    ...
    for ncfile in ncfiles[0:1]:
        ...
        if HN == 'Maria':
            ax[hn_counter,i].set_extent([-57,-69, 13 , 18])
