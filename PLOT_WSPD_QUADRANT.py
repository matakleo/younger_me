...
#for switching between YSU_1 and YSU_2 and COAWST, make changes in INPUT_DIR

#YSU_1
# Input_Dir = '/Users/lmatak/Downloads/clz_cases/wspd_quadrant/QUADRANT_'+quad_select+'/'

#YSU_2
Input_Dir = '/Users/lmatak/Downloads/clz_cases/wspd_quadrant/YSU_2/QUADRANT_'+quad_select+'/'
# Input_Dir = '/Users/lmatak/Downloads/clz_cases/wspd_quadrant/YSU2_first_and_last/'
#COAWST
# Input_Dir = '/Users/lmatak/Downloads/clz_cases/WSPD_SLP/COAWST_first_and_last/QUADRANT_'+quad_select+'/'
# for MYJ 'Maria','Dorian','Iota','Teddy','Lorenzo , Igor
HNS = ['Katrina','Maria','Dorian','Igor','Lorenzo']
# HNS=['Igor','Katrina','Maria']
...
for PBL in PBLS:
    ...
    for HN in HNS :
        ...
        for CL in CLS:
                ...
                ax[col_count].plot(rads[0:show], WSPD[0:show], color=colors[cls_counter],  linestyle='-',
...
#              )
fig.suptitle('YSU2-500m',size=20)
